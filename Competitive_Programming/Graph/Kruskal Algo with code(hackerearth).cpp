...
// If their exist a already path from node A to node B , then adding A---B will make cycle.To get rid of a cycle , we should remove one edge from it.As all edges are sorted according to weight then previous values must be smaller than A---B weight,
// hence remove A---B only , or just don't add this Edge.
#include<bits/stdc++.h>
#define ll long long
...
edge arr[100000]; // off size number of edges
int par[10001]; // off size number of nodes
