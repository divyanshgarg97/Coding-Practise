...
// //     // dp[x][t] = maximum amount of snakes that T can catch when at x coordinate and time t
// //     // dp[x][t] = max(dp[x-1][t-1], dp[x][t-1], dp[x+1][t-1])
// //     // x can be 0 to 5 and time is  10^5
// //     // If I fill dp like first i loop then j loop, then not work as I need ans for [i+1][t-1]
// //     // so rotate and fill j and then i 
